...
export interface adminProfitAttributes {
  id: string;
...
export type adminProfitPk = "id";
export type adminProfitId = adminProfit[adminProfitPk];
export type adminProfitOptionalAttributes =
  | "id"
  | "chain"
  | "description"
  | "createdAt"
  | "deletedAt"
  | "updatedAt";
export type adminProfitCreationAttributes = Optional<
  adminProfitAttributes,
  adminProfitOptionalAttributes
>;

export class adminProfit
  ...
  implements adminProfitAttributes
{
  ...
  static initModel(sequelize: Sequelize.Sequelize): typeof adminProfit {
