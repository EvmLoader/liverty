...
import { adminProfit as AdminProfit } from "./adminProfit";
import type {
  adminProfitAttributes,
  adminProfitCreationAttributes,
} from "./adminProfit";
...
import { ecosystemBlockchain as EcosystemBlockchain } from "./ecosystemBlockchain";
import type {
  ecosystemBlockchainAttributes,
  ecosystemBlockchainCreationAttributes,
} from "./ecosystemBlockchain";
...
// NFT
import { nftAsset as NftAsset } from "./nftAsset";
import type {
  nftAssetAttributes,
  nftAssetCreationAttributes,
} from "./nftAsset";
import { nftAttribute as NftAttribute } from "./nftAttribute";
import type {
  nftAttributeAttributes,
  nftAttributeCreationAttributes,
} from "./nftAttribute";
import { nftAuction as NftAuction } from "./nftAuction";
import type {
  nftAuctionAttributes,
  nftAuctionCreationAttributes,
} from "./nftAuction";
import { nftBid as NftBid } from "./nftBid";
import type { nftBidAttributes, nftBidCreationAttributes } from "./nftBid";
import { nftCategory as NftCategory } from "./nftCategory";
import type {
  nftCategoryAttributes,
  nftCategoryCreationAttributes,
} from "./nftCategory";
import { nftComment as NftComment } from "./nftComment";
import type {
  nftCommentAttributes,
  nftCommentCreationAttributes,
} from "./nftComment";
import { nftLike as NftLike } from "./nftLike";
import type { nftLikeAttributes, nftLikeCreationAttributes } from "./nftLike";
import { nftTransaction as NftTransaction } from "./nftTransaction";
import type {
  nftTransactionAttributes,
  nftTransactionCreationAttributes,
} from "./nftTransaction";
import type {
...
export {
  ...
  EcosystemBlockchain as ecosystemBlockchain,
  ...
  NftAttribute as nftAttribute,
  NftAuction as nftAuction,
  NftBid as nftBid,
  NftCategory as nftCategory,
  NftComment as nftComment,
  NftLike as nftLike,
  NftTransaction as nftTransaction,
...
export type {
  ...
  nftAttributeCreationAttributes,
  nftBidAttributes,
  nftBidCreationAttributes,
  nftCategoryAttributes,
  nftCategoryCreationAttributes,
  nftCommentAttributes,
  nftCommentCreationAttributes,
  nftLikeAttributes,
  nftLikeCreationAttributes,
  nftTransactionAttributes,
  nftTransactionCreationAttributes,
  oneTimeTokenAttributes,
  oneTimeTokenCreationAttributes,
...
export function initModels(sequelize: Sequelize) {
  const adminProfit = AdminProfit.initModel(sequelize);
  ...
  const ecosystemBlockchain = EcosystemBlockchain.initModel(sequelize);
  ...
  const nftAsset = NftAsset.initModel(sequelize);
  const nftAttribute = NftAttribute.initModel(sequelize);
  const nftAuction = NftAuction.initModel(sequelize);
  const nftBid = NftBid.initModel(sequelize);
  const nftCategory = NftCategory.initModel(sequelize);
  const nftComment = NftComment.initModel(sequelize);
  const nftLike = NftLike.initModel(sequelize);
  const nftTransaction = NftTransaction.initModel(sequelize);
  ...
  // adminProfit has transaction id
  adminProfit.belongsTo(transaction, {
    as: "transaction",
    foreignKey: "transactionId",
    onDelete: "CASCADE",
    onUpdate: "CASCADE",
  });
  transaction.hasOne(adminProfit, {
    as: "adminProfit",
    foreignKey: "transactionId",
    onDelete: "CASCADE",
    onUpdate: "CASCADE",
  ...
  // MLM
  // User Associations
  user.hasMany(mlmReferral, {
    as: "referredReferrals", // Referrals where the user is the referred (direct downlines)
  ...
  user.hasMany(mlmReferral, {
    as: "referrerReferrals", // Referrals where the user is the referrer
    foreignKey: "referrerId",
    onDelete: "CASCADE",
    onUpdate: "CASCADE",
  });

  // MLM Referral Associations
  ...
  user.hasMany(mlmReferralReward, {
    as: "referralRewards", // Rewards earned by this user
    foreignKey: "referrerId",
    onDelete: "CASCADE",
    onUpdate: "CASCADE",
  });
  ...
  /* -----------------------------------
     nftAsset Associations
  ----------------------------------- */

  // nftAsset belongsTo nftCategory via categoryId
  nftAsset.belongsTo(nftCategory, {
    as: "category",
    foreignKey: "categoryId",
    onDelete: "SET NULL",
    onUpdate: "CASCADE",
  });
  nftCategory.hasMany(nftAsset, {
    as: "nftAssets",
    foreignKey: "categoryId",
    onDelete: "SET NULL",
    onUpdate: "CASCADE",
  ...
  nftAsset.belongsTo(user, {
    as: "creator",
    foreignKey: "creatorId",
    onDelete: "CASCADE",
    onUpdate: "CASCADE",
  });
  user.hasMany(nftAsset, {
    as: "createdNfts",
    foreignKey: "creatorId",
    onDelete: "CASCADE",
    onUpdate: "CASCADE",
  ...
  nftAsset.hasMany(nftAttribute, {
    as: "nftAttributes",
    foreignKey: "nftAssetId",
    onDelete: "CASCADE",
    onUpdate: "CASCADE",
  });
  nftAttribute.belongsTo(nftAsset, {
    as: "nftAsset",
    foreignKey: "nftAssetId",
    onDelete: "CASCADE",
    onUpdate: "CASCADE",
  ...
  nftAsset.hasMany(nftBid, {
    as: "nftBids",
    foreignKey: "nftAssetId",
    onDelete: "CASCADE",
    onUpdate: "CASCADE",
  });
  nftBid.belongsTo(nftAsset, {
    as: "nftAsset",
    foreignKey: "nftAssetId",
    onDelete: "CASCADE",
    onUpdate: "CASCADE",
  ...
  nftAsset.hasMany(nftTransaction, {
    as: "nftTransactions",
    foreignKey: "nftAssetId",
    onDelete: "CASCADE",
    onUpdate: "CASCADE",
  });
  nftTransaction.belongsTo(nftAsset, {
    as: "nftAsset",
    foreignKey: "nftAssetId",
    onDelete: "CASCADE",
    onUpdate: "CASCADE",
  ...
  nftAsset.hasOne(nftAuction, {
    as: "nftAuction",
    foreignKey: "nftAssetId",
    onDelete: "CASCADE",
    onUpdate: "CASCADE",
  });
  nftAuction.belongsTo(nftAsset, {
    as: "nftAsset",
    foreignKey: "nftAssetId",
    onDelete: "CASCADE",
    onUpdate: "CASCADE",
  ...
  nftAsset.hasMany(nftLike, {
    as: "nftLikes",
    foreignKey: "nftAssetId",
    onDelete: "CASCADE",
    onUpdate: "CASCADE",
  });
  nftLike.belongsTo(nftAsset, {
    as: "nftAsset",
    foreignKey: "nftAssetId",
    onDelete: "CASCADE",
    onUpdate: "CASCADE",
  ...
  nftAsset.hasMany(nftComment, {
    as: "nftComments",
    foreignKey: "nftAssetId",
    onDelete: "CASCADE",
    onUpdate: "CASCADE",
  });
  nftComment.belongsTo(nftAsset, {
    as: "nftAsset",
    foreignKey: "nftAssetId",
    onDelete: "CASCADE",
    onUpdate: "CASCADE",
  ...
  /* -----------------------------------
     nftAttribute Associations
  ----------------------------------- */

  // Already associated above with nftAsset
  ...
  // Already associated above

  // nftBid belongsTo user via bidderId
  nftBid.belongsTo(user, {
    as: "bidder",
    foreignKey: "bidderId",
    onDelete: "CASCADE",
    onUpdate: "CASCADE",
  ...
  nftBid.belongsTo(nftAuction, {
    as: "nftAuction",
    foreignKey: "auctionId",
    onDelete: "CASCADE",
    onUpdate: "CASCADE",
  });
  nftAuction.hasMany(nftBid, {
    as: "nftBids",
    foreignKey: "auctionId",
    onDelete: "CASCADE",
    onUpdate: "CASCADE",
  ...
  nftTransaction.belongsTo(user, {
    as: "seller",
    foreignKey: "sellerId",
    onDelete: "CASCADE",
    onUpdate: "CASCADE",
  });
  user.hasMany(nftTransaction, {
    as: "soldNftTransactions",
    foreignKey: "sellerId",
    onDelete: "CASCADE",
    onUpdate: "CASCADE",
  });
  ...
  /* -----------------------------------
     nftAuction Associations
  ----------------------------------- */

  // nftAuction belongsTo nftAsset via nftAssetId
  // Already associated above

  // nftAuction hasMany nftBid via auctionId
  // Already associated above

  /* -----------------------------------
     nftLike Associations
  ----------------------------------- */
  ...
  nftLike.belongsTo(user, {
    as: "user",
    foreignKey: "userId",
    onDelete: "CASCADE",
    onUpdate: "CASCADE",
  });
  user.hasMany(nftLike, {
    as: "nftLikes",
    foreignKey: "userId",
    onDelete: "CASCADE",
    onUpdate: "CASCADE",
  ...
  nftComment.belongsTo(user, {
    as: "user",
    foreignKey: "userId",
    onDelete: "CASCADE",
    onUpdate: "CASCADE",
  });
  user.hasMany(nftComment, {
    as: "nftComments",
    foreignKey: "userId",
    onDelete: "CASCADE",
    onUpdate: "CASCADE",
  ...
  return {
    ...
    ecosystemBlockchain: ecosystemBlockchain,
