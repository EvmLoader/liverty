...
export interface ecosystemBlockchainAttributes {
  id: string;
  productId: string;
  name: string;
  chain?: string;
...
export type ecosystemBlockchainPk = "id";
export type ecosystemBlockchainId = ecosystemBlockchain[ecosystemBlockchainPk];
export type ecosystemBlockchainOptionalAttributes =
  | "id"
  | "chain"
  | "description"
  | "link"
  ...
  | "version"
  | "image";
export type ecosystemBlockchainCreationAttributes = Optional<
  ...
  implements ecosystemBlockchainAttributes
{
  ...
  static initModel(sequelize: Sequelize.Sequelize): typeof ecosystemBlockchain {
